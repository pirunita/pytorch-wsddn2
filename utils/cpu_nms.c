...
#define __PYX_HAVE__utils__cpu_nms
#define __PYX_HAVE_API__utils__cpu_nms
#include <string.h>
#include <stdio.h>
#include <stdlib.h>
...
/* Module declarations from 'utils.cpu_nms' */
static CYTHON_INLINE __pyx_t_5numpy_float32_t __pyx_f_5utils_7cpu_nms_max(__pyx_t_5numpy_float32_t, __pyx_t_5numpy_float32_t); /*proto*/
static CYTHON_INLINE __pyx_t_5numpy_float32_t __pyx_f_5utils_7cpu_nms_min(__pyx_t_5numpy_float32_t, __pyx_t_5numpy_float32_t); /*proto*/
static __Pyx_TypeInfo __Pyx_TypeInfo_nn___pyx_t_5numpy_float32_t = { "float32_t", NULL, sizeof(__pyx_t_5numpy_float32_t), { 0 }, 0, 'R', 0, 0 };
static __Pyx_TypeInfo __Pyx_TypeInfo_nn___pyx_t_5numpy_int_t = { "int_t", NULL, sizeof(__pyx_t_5numpy_int_t), { 0 }, 0, IS_UNSIGNED(__pyx_t_5numpy_int_t) ? 'U' : 'I', IS_UNSIGNED(__pyx_t_5numpy_int_t), 0 };
#define __Pyx_MODULE_NAME "utils.cpu_nms"
int __pyx_module_is_main_utils__cpu_nms = 0;

/* Implementation of 'utils.cpu_nms' */
...
static const char __pyx_k_npzz[] = "npzz";
...
static const char __pyx_k_utils_cpu_nms[] = "utils.cpu_nms";
static const char __pyx_k_wsddn_utils_cpu_nms_pyx[] = "/wsddn/utils/cpu_nms.pyx";
...
static PyObject *__pyx_n_s_npzz;
...
static PyObject *__pyx_n_s_utils_cpu_nms;
static PyObject *__pyx_n_s_w;
static PyObject *__pyx_kp_s_wsddn_utils_cpu_nms_pyx;
...
static PyObject *__pyx_pf_5utils_7cpu_nms_cpu_nms(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_dets, PyObject *__pyx_v_thresh); /* proto */
...
static CYTHON_INLINE __pyx_t_5numpy_float32_t __pyx_f_5utils_7cpu_nms_max(__pyx_t_5numpy_float32_t __pyx_v_a, __pyx_t_5numpy_float32_t __pyx_v_b) {
  __pyx_t_5numpy_float32_t __pyx_r;
  __Pyx_RefNannyDeclarations
  __pyx_t_5numpy_float32_t __pyx_t_1;
  __Pyx_RefNannySetupContext("max", 0);

  /* "utils/cpu_nms.pyx":12
 * 
 * cdef inline np.float32_t max(np.float32_t a, np.float32_t b):
 *     return a if a >= b else b             # <<<<<<<<<<<<<<
 * 
...
static CYTHON_INLINE __pyx_t_5numpy_float32_t __pyx_f_5utils_7cpu_nms_min(__pyx_t_5numpy_float32_t __pyx_v_a, __pyx_t_5numpy_float32_t __pyx_v_b) {
  __pyx_t_5numpy_float32_t __pyx_r;
  __Pyx_RefNannyDeclarations
  __pyx_t_5numpy_float32_t __pyx_t_1;
  __Pyx_RefNannySetupContext("min", 0);

  /* "utils/cpu_nms.pyx":15
 * 
 * cdef inline np.float32_t min(np.float32_t a, np.float32_t b):
 *     return a if a <= b else b             # <<<<<<<<<<<<<<
 * 
...
/* Python wrapper */
static PyObject *__pyx_pw_5utils_7cpu_nms_1cpu_nms(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_5utils_7cpu_nms_1cpu_nms = {"cpu_nms", (PyCFunction)__pyx_pw_5utils_7cpu_nms_1cpu_nms, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_5utils_7cpu_nms_1cpu_nms(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __pyx_L3_error:;
  __Pyx_AddTraceback("utils.cpu_nms.cpu_nms", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  ...
  __pyx_r = __pyx_pf_5utils_7cpu_nms_cpu_nms(__pyx_self, __pyx_v_dets, __pyx_v_thresh);
...
static PyObject *__pyx_pf_5utils_7cpu_nms_cpu_nms(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_dets, PyObject *__pyx_v_thresh) {
 ...
 */
      ...
      __pyx_v_xx1 = __pyx_f_5utils_7cpu_nms_max(__pyx_v_ix1, (*__Pyx_BufPtrStrided1d(__pyx_t_5numpy_float32_t *, __pyx_pybuffernd_x1.rcbuffer->pybuffer.buf, __pyx_t_30, __pyx_pybuffernd_x1.diminfo[0].strides)));

      /* "utils/cpu_nms.pyx":58
 *                 continue
 *             xx1 = max(ix1, x1[j])
 *             yy1 = max(iy1, y1[j])             # <<<<<<<<<<<<<<
 *             xx2 = min(ix2, x2[j])
 ...
 */
      ...
      __pyx_v_yy1 = __pyx_f_5utils_7cpu_nms_max(__pyx_v_iy1, (*__Pyx_BufPtrStrided1d(__pyx_t_5numpy_float32_t *, __pyx_pybuffernd_y1.rcbuffer->pybuffer.buf, __pyx_t_31, __pyx_pybuffernd_y1.diminfo[0].strides)));

      /* "utils/cpu_nms.pyx":59
 *             xx1 = max(ix1, x1[j])
 *             yy1 = max(iy1, y1[j])
 *             xx2 = min(ix2, x2[j])             # <<<<<<<<<<<<<<
 *             yy2 = min(iy2, y2[j])
 ...
 */
      ...
      __pyx_v_xx2 = __pyx_f_5utils_7cpu_nms_min(__pyx_v_ix2, (*__Pyx_BufPtrStrided1d(__pyx_t_5numpy_float32_t *, __pyx_pybuffernd_x2.rcbuffer->pybuffer.buf, __pyx_t_32, __pyx_pybuffernd_x2.diminfo[0].strides)));

      /* "utils/cpu_nms.pyx":60
 *             yy1 = max(iy1, y1[j])
 *             xx2 = min(ix2, x2[j])
 *             yy2 = min(iy2, y2[j])             # <<<<<<<<<<<<<<
 *             w = max(0.0, xx2 - xx1 + 1)
 ...
 */
      ...
      __pyx_v_yy2 = __pyx_f_5utils_7cpu_nms_min(__pyx_v_iy2, (*__Pyx_BufPtrStrided1d(__pyx_t_5numpy_float32_t *, __pyx_pybuffernd_y2.rcbuffer->pybuffer.buf, __pyx_t_33, __pyx_pybuffernd_y2.diminfo[0].strides)));

      /* "utils/cpu_nms.pyx":61
 *             xx2 = min(ix2, x2[j])
 *             yy2 = min(iy2, y2[j])
 *             w = max(0.0, xx2 - xx1 + 1)             # <<<<<<<<<<<<<<
 *             h = max(0.0, yy2 - yy1 + 1)
 *             inter = w * h
 */
      __pyx_v_w = __pyx_f_5utils_7cpu_nms_max(0.0, ((__pyx_v_xx2 - __pyx_v_xx1) + 1.0));

      /* "utils/cpu_nms.pyx":62
 *             yy2 = min(iy2, y2[j])
 *             w = max(0.0, xx2 - xx1 + 1)
 *             h = max(0.0, yy2 - yy1 + 1)             # <<<<<<<<<<<<<<
 *             inter = w * h
 ...
 */
      __pyx_v_h = __pyx_f_5utils_7cpu_nms_max(0.0, ((__pyx_v_yy2 - __pyx_v_yy1) + 1.0));

      /* "utils/cpu_nms.pyx":63
 *             w = max(0.0, xx2 - xx1 + 1)
 *             h = max(0.0, yy2 - yy1 + 1)
 *             inter = w * h             # <<<<<<<<<<<<<<
 *             ovr = inter / (iarea + areas[j] - inter)
...
static CYTHON_INLINE int __pyx_f_5numpy_import_array(void) {
  ...
  /* "../usr/local/lib/python3.6/dist-packages/Cython/Includes/numpy/__init__.pxd":986
 * # Cython code.
 * cdef inline int import_array() except -1:
 *     try:             # <<<<<<<<<<<<<<
 *         _import_array()
 ...
 */
    ...
    /* "../usr/local/lib/python3.6/dist-packages/Cython/Includes/numpy/__init__.pxd":994
 *     try:
 *         _import_umath()
 *     except Exception:             # <<<<<<<<<<<<<<
 *         raise ImportError("numpy.core.umath failed to import")
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_npzz, __pyx_k_npzz, sizeof(__pyx_k_npzz), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_utils_cpu_nms, __pyx_k_utils_cpu_nms, sizeof(__pyx_k_utils_cpu_nms), 0, 0, 1, 1},
  {&__pyx_n_s_w, __pyx_k_w, sizeof(__pyx_k_w), 0, 0, 1, 1},
  {&__pyx_kp_s_wsddn_utils_cpu_nms_pyx, __pyx_k_wsddn_utils_cpu_nms_pyx, sizeof(__pyx_k_wsddn_utils_cpu_nms_pyx), 0, 0, 1, 0},
 ...
 */
  ...
  __pyx_codeobj__22 = (PyObject*)__Pyx_PyCode_New(2, 0, 29, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__21, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_wsddn_utils_cpu_nms_pyx, __pyx_n_s_cpu_nms, 17, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__22)) __PYX_ERR(0, 17, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
#endif
{
  ...
  #endif
  if (__pyx_module_is_main_utils__cpu_nms) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "utils.cpu_nms")) {
      if (unlikely(PyDict_SetItemString(modules, "utils.cpu_nms", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_npzz, __pyx_t_1) < 0) __PYX_ERR(0, 8, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 *     cdef np.ndarray[np.float32_t, ndim=1] y1 = dets[:, 1]
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_5utils_7cpu_nms_1cpu_nms, NULL, __pyx_n_s_utils_cpu_nms); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 17, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init utils.cpu_nms", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init utils.cpu_nms");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
